"""
Django settings for trakz_40382 project.
...
WSGI_APPLICATION = 'trakz_40382.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trakz_40382 API",
    "DESCRIPTION": "API documentation for trakz_40382 App",
    "VERSION": "v1",
}
